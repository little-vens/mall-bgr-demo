		...
		<div class="content-wrapper">
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data text">${orders.members.nickName }</div>

					<div class="col-md-2 title">联系人</div>
					<div class="col-md-4 data text">${orders.members.name}</div>

					<div class="col-md-2 title">手机号</div>
					<div class="col-md-4 data text">${orders.members.phoneNum}</div>

					<div class="col-md-2 title">邮箱</div>
					<div class="col-md-4 data text">${orders.members.email}</div>
